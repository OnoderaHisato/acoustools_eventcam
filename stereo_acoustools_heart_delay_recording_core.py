...
def run_recording(
    ...
    *,
    ...
    try:
        ...
        if bool(args.delay_feedforward):
        ...
        parameters["control_mode"] = (
            "delay_feedforward" if bool(args.delay_feedforward) else "baseline"
        )
        ...
        pipeline_manifest = {
            ...
            "control": {
                "mode": "delay_feedforward" if bool(args.delay_feedforward) else "baseline",
                "equation": "u(t) = r(t) + tau * dr(t)/dt",
