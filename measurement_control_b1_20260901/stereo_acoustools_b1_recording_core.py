#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""B1 variant of the stereo 3D recording core (adds --inverse2nd-feedforward).

Copy of stereo_acoustools_3d_recording_core.py extended with the per-axis
second-order inverse (design C) feedforward mode for the B1 ON/OFF experiment.
The original file is unchanged; keep both in the same directory.
...
from delay_feedforward import apply_delay_feedforward
    ...
    try:
        ...
        pipeline_manifest = {
            ...
            "control": {
                ...
                "equation": (
                    "u(t) = r(t+tau) + (r''(t+tau) + gamma*r'(t+tau)) / w0^2  (per axis)"
